import to_string as to_string
import merge_sort_linked_list as merge_sort
...
result1, result2 = merge_sort.split_chain(achain)
str_result1 = to_string.to_string(result1)
str_result2 = to_string.to_string(result2)
...
result = merge_sort.merge(achain, anotherchain)
str_result = to_string.to_string(result)
...
result = merge_sort.merge_sort(achain)
str_result = to_string.to_string(result)
if str_result != expected:
